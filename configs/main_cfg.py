CFG = {
    ...
    'lidar_max_dist': 3,  # Maximum distance for lidar sensitivity (if None, exponential distance)
    ...
    'goal_keepout': 0.305,  # Keepout radius when placing goals
    ...
    'hazards_keepout': 0.18,  # Radius of hazard keepout for placement
    'hazards_size': 0.2,  # Radius of hazards
    'hazards_cost': 1.0,  # Cost (per step) for violating the constraint

    # Vases (objects we should not touch)
    'vases_num': 1,  # Number of vases in the world

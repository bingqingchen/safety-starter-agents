...
sys.path.append('/data/workspaces/jmf1/spinningup')
import spinup.algos.pytorch.ppo.core as core
from spinup.utils.logx import EpochLogger
from spinup.utils.mpi_pytorch import setup_pytorch_for_mpi, sync_params, mpi_avg_grads
from spinup.utils.mpi_tools import mpi_fork, mpi_sum, mpi_avg, proc_id, mpi_statistics_scalar, num_procs
...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        steps_per_epoch=30000, epochs=334, gamma=0.99, clip_ratio=0.2, pi_lr=3e-4,
        vf_lr=1e-3, train_pi_iters=80, train_v_iters=80, lam=0.97, max_ep_len=1000,
        target_kl=0.01, render=False, logger_kwargs=dict(), reward_scale=1, save_freq=50):
    """
    ...
    for epoch in range(epochs):
        ...
        #logger.log_tabular('TotalTime', time.time()-epoch_start_time)
        logger.dump_tabular()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=334)
    parser.add_argument('--exp_name', type=str, default='ppo-spinningup')
    ...
    ppo(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
        ...
        render=args.render, logger_kwargs=logger_kwargs)
